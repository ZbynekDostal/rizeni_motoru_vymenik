...
void loop() {
  ...
  stepper1.moveTo(3000); // Set desired move: 800 steps (in quater-step resolution that's one rotation)
  ...
  {
      encoderPosition = map(encoderPosition, 0, 16384, 0, 6400) - offset;
